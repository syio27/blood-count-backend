...
@ControllerAdvice
public class ReferenceTableHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(ReferenceTableException.class)
    public ResponseEntity<Object> handleReferenceTableNotFullException(
            ReferenceTableException ex, WebRequest request) {
